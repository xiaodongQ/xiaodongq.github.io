...
利用AI来提升学习和实践效率：  
* 1、先用AI（`Claude Code`或者`DeepSeek`等页面问答）生成提示词
* 2、将提示词喂给`Claude Code`来生成学习资料
...
2、将上述提示词的markdown形式给`Claude Code`，让它生成资料

生成的仓库：[ai-claude-code-guide](https://github.com/xiaodongQ/ai-claude-code-guide)
