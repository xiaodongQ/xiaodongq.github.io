...
![扫码连接界面](/assets/images/happy-scan-qr.webp){: .screenshot-mobile}
...
![设置界面 - 已连接 xdlinux 设备](/assets/images/happy-device-list.webp){: .screenshot-mobile}
...
![设备详情 - 工作目录、守护进程状态、端口信息](/assets/images/happy-device-detail.webp){: .screenshot-mobile}
...
![Command 提示 - 命令自动补全](/assets/images/happy-command-prompt.webp){: .screenshot-mobile}

### 5. Skill 调用

![Skill 执行 - 权限模式/剩余量](/assets/images/happy-skill-execution.webp){: .screenshot-mobile}

### 6. 多会话管理

![多会话管理 - 新建/切换会话](/assets/images/happy-multi-session.webp){: .screenshot-mobile}
...
![hapi 聊天界面测试](/assets/images/hapi-chat-test.webp){: .screenshot-mobile}
