...
在文件被删除后，GFS**不会立刻回收**可用的物理存储空间。master仅在`周期性`执行`懒式垃圾回收`时回收物理存储空间，其中垃圾回收分为文件级垃圾回收和chunk级垃圾回收。
...
4、[视频：Lecture 2 - GFS](https://www.bilibili.com/video/BV1R7411t71W?p=3&vd_source=477b80445c7c1a81617bbea3bdf9a3c1)
