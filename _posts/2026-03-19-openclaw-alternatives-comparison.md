---
title: OpenClaw系列 -- OpenClaw 开源替代项目对比
...
到[picoclaw/releases](https://github.com/sipeed/picoclaw/releases)下载二进制文件即可。

`./picoclaw-launcher`进入可视化页面，配置添加模型。此处选择添加`MiniMax-M3`模型，选择`anthropic-messages`，其他信息可参考如下配置：

```sh
{
    "model_name": "xd-minimax",
