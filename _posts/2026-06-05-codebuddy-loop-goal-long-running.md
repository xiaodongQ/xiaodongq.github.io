---
title: AI能力集 -- 解决 Claude Code /loop 3天自动失效问题：可行方案与风险对比
description: 解析 loop 3 天过期底层机制，验证各类续命方案的实际缺陷，对比 Goal 临时保活与 Windows CLI 外置定时两种真正可行路径，明确适用场景、优缺点和风险边界
categories: [AI, AI能力集]
...
我对各种续命方案进行了实际调研和验证，发现大多数方案存在隐性断点。本文将：
